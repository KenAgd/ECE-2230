...
int main(int argc, char *argv[])
{
    ...
    printf("Exposures  : RECEXP time; CLEAREXP; PRINTEXP; SORT; APPEXP\n");
    printf("           : STATS; QUIT\n");
    ...
    while (fgets(line, MAXLINE, stdin) != NULL) {
        ...
        if (num_items == 2 && strcmp(command, "CREATE") == 0) {
            ...
            ens_list_sort(unsorted_list, command_number);
        } 
        
        else if (strcmp(command, "APPEXP") == 0) {
            ens_appexp(unsorted_list, command_number);
//            ens_print(unsorted_list, "Exposure");
        }                 
